...
class Agent():
    ...
    def learn(self, num_episode, num_steps_per_episode,
              noise_theta=0.15, noise_sigma=0.2, replay_buffer_size=10**6, batch_size=32,
        ...
        for _episode in range(1, num_episode+1):
            ...
            for _t in range(1, num_steps_per_episode+1):
                ...
                action = (normalized_action + 1. + self.env.action_space.low) \
                ...
                replaybuffer.add(observation, normalized_action, reward, observation_next, done)
